...
test("renders label with correct text and input field", () => {
  render(<Label text="Test Label" htmlFor="test-input" placeholder="Type here" />);
...
test("label and input should be disabled when disabled prop is true", () => {
  render(<Label text="Disabled Label" htmlFor="disabled-input" placeholder="Can't type" disabled />);
